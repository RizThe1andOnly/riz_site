            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            Did integration testing with the various services by launching them in a development environment. I utilized <strong>Docker Compose</strong> to launch
                        ...
                        <li>
                            Used <strong>Jaeger Tracing</strong> to trace requuests across the different services for debugging purposes.
                        </li>
                        <li>
                            Developed a feature to move data from one service to another utilizing REST endpoints and Java BufferedStreams.
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            Used a combination of shell commands and Python's subprocess module to collect logs produced by the router. The router had a Linux
                            ...
                            Used Python's subprocess module to open an ssh connection to the router, then apply a "tail" command for the file with the logs 
                            to extract the most recent logs.
                        </li>

                        <li>Used Python string operations and <strong>Regular Expressions</strong> to parse the logs into meaningful metrics for our project.</li>
                        ...
                        <li>Used <strong>Python Socket Programming</strong> to open sockets to other components of the project to transfer metrics.</li>

                        <li>Worked with <strong>Prometheus Database</strong> to store metrics and <strong>Grafana</strong> to display the metrics.</li>

                        <li>Used the <strong>singleton design pattern</strong> to create a single instance object for access to data storage across the project. This object would be shared by the various parts of the projects that handled the processing of the metrics.</li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            Wrote scripts to initiate tests and validate the results. This invovled working with Python strings and byte arrays.
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            Used the <strong>rule engine design pattern</strong> to cretate an Ip validator. Validation would involve checking Ip addresses or
                            subnets to ensure they were not erroneous.
                        </li>

                        <li>
                            Used <strong>Parasoft Unit Test Tool for C/C++</strong> to create and run unit test on modules I created and already existing modules.
                        </li>
                    </ul>
                </li>
            </ul>
